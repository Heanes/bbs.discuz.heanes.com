...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1432088626, '1', './data/template/1_1_common_header_home_spacecp.tpl.php', './template/default', 'common/header_home_spacecp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1432088626, '1', './data/template/1_1_common_header_home_spacecp.tpl.php', './template/default', 'common/header_home_spacecp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1432088626, '1', './data/template/1_1_common_header_home_spacecp.tpl.php', './template/default', 'common/header_home_spacecp')
;?>
