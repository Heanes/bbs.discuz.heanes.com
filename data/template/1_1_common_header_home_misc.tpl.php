...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1433152145, '1', './data/template/1_1_common_header_home_misc.tpl.php', './template/default', 'common/header_home_misc')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1433152145, '1', './data/template/1_1_common_header_home_misc.tpl.php', './template/default', 'common/header_home_misc')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1433152145, '1', './data/template/1_1_common_header_home_misc.tpl.php', './template/default', 'common/header_home_misc')
;?>
