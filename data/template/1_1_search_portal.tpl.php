...
0
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/header.htm', 1433150338, '1', './data/template/1_1_search_portal.tpl.php', './template/default', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/pubsearch.htm', 1433150338, '1', './data/template/1_1_search_portal.tpl.php', './template/default', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/portal_list.htm', 1433150338, '1', './data/template/1_1_search_portal.tpl.php', './template/default', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/footer.htm', 1433150338, '1', './data/template/1_1_search_portal.tpl.php', './template/default', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/common/header_common.htm', 1433150338, '1', './data/template/1_1_search_portal.tpl.php', './template/default', 'search/portal')
;?>
