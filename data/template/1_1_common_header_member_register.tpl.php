...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1438323952, '1', './data/template/1_1_common_header_member_register.tpl.php', './template/default', 'common/header_member_register')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1438323952, '1', './data/template/1_1_common_header_member_register.tpl.php', './template/default', 'common/header_member_register')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1438323952, '1', './data/template/1_1_common_header_member_register.tpl.php', './template/default', 'common/header_member_register')
;?>
